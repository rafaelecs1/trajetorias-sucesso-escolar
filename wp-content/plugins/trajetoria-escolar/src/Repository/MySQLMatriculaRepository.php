...
class MySQLMatriculaRepository extends AbstractRepository
{
    ...
    public function getDataMatriculaRegiao($regiaoId, $anoReferencia){

        $mapa = $this->getCacheBrasil($regiaoId, $anoReferencia, self::REGIAO_MATRICULA);
        ...
        $data->cor_raca->indigena = $this->getTotalMatriculasEstadoMunicipioEscola($anoReferencia,  6, null, null, null, null, null, $regiaoId);
        ...
        $data->deficiencia->com = $this->getTotalPainelDeficiente($anoReferencia, 1, self::REGIAO_MATRICULA, null, null, $regiaoId);
        $data->deficiencia->sem = $this->getTotalPainelDeficiente($anoReferencia, 0, self::REGIAO_MATRICULA, null, null, $regiaoId);

        $this->saveBrasil($regiaoId, self::REGIAO_MATRICULA, $anoReferencia, $data);
    ...
    public function getDataMatriculaMunicipio($municipioId, $anoReferencia)
    {

        $mapa = $this->getCacheBrasil($municipioId, $anoReferencia, self::MUNICIPIO_MATRICULA);
    ...
    public function getDataMatriculaEscola($escolaId, $anoReferencia)
    {

        $mapa = $this->getCacheBrasil($escolaId, $anoReferencia, self::ESCOLA_MATRICULA);
