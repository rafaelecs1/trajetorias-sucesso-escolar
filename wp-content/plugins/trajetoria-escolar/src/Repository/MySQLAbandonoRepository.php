...
class MySQLAbandonoRepository extends AbstractRepository{
    ...
    public function getDataAbandonoRegiao($regiaoId, $anoReferencia)
    {

        $mapa = $this->getCacheBrasil($regiaoId, $anoReferencia, self::REGIAO_ABANDONO);
        ...
        $data->deficiencia->com = $this->getTotalPainelDeficiente($anoReferencia, 1, self::REGIAO_ABANDONO, null, null, $regiaoId);
        $data->deficiencia->sem = $this->getTotalPainelDeficiente($anoReferencia, 0, self::REGIAO_ABANDONO, null, null, $regiaoId);

        $this->saveBrasil($regiaoId, self::REGIAO_ABANDONO, $anoReferencia, $data);
