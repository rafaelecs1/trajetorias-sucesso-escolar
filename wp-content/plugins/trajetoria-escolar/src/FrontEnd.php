...
class FrontEnd
{
    ...
    public function __construct()
    {
        ...
        add_shortcode('mapa_nacional', array($this, 'mapaNacional'));
    ...
    /**
     * Retorna o mapa do Brasil com resumo dos dados da distorcao idade-serie no Brasil
     *
     * @return string Marcação HTML
     */
    public function mapaNacional(){
                            ...
                            <div class="conteudo">
                                ...
                                <div class="valores">
                                    ...
                                    <div class="item iniciais">
                                        <h4>Anos iniciais</h4>
                                        <div class="value value_fi">1.713.637</div>
                                        <div class="perc">[<span class="perc_fi">43</span>]%</div>
                                    </div>

                                    <div class="item finais">
                                        <h4>Anos finais</h4>
                                        <div class="value value_ff">1.713.637</div>
                            ...
                            <div class="conteudo">
                                ...
                                <div class="valores">
                                    ...
                                    <div class="item unico">
                                        <div class="value value_mi">1.713.637</div>
