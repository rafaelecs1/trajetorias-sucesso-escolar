    ...
    public function formImportarCsv()
    {
        ...
        <section>
            ...
            <form method="post" enctype="multipart/form-data">
                <div class="form-item">
                    <label for="tipo_informacao">Qual o tipo de informações sobre distorção idade-série gostaria de importar?</label>
                    <br/>
                ...
                <div class="form-item">
                    <label for="ano_referencia">Qual o ano de referência das informações sobre distorção idade-série?</label>
                    <br />
                ...
                <fieldset>
                    ...
                    <ul>
                        <li>A importação pode consumir muitos recursos do servidor. Recomenda-se realizar essa operação fora do horário de pico de acessos;</li>
                        <li>Certificar-se de que nenhum outro usuário está realizando publicando ou alterando informações no site;</li>
    ...
    public function importarCsv()
    {
        if (current_user_can('manage_options') && isset($_FILES['csv']) && !empty($_FILES['csv'])) {
            ...
            try {
                ...
                header('Location: ' . admin_url('admin.php?page=importar_csv&resultado=ok'));
            } catch (\Exception $e) {
                $wpdb->query('ROLLBACK');
